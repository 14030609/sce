...
<html lang="en">
  <head>
    ...
    <!-- Fancybox slider -->
    <link rel="stylesheet" href="assets/assets/css/jquery.fancybox.css" type="text/css" media="screen" /> 
    <!-- Theme color -->
    <link id="switcher" href="assets/assets/css/theme-color/default-theme.css" rel="stylesheet">  
       ...
       <div class="col-md-12">
         <div class="mu-gallery-area">
          ...
          <div class="mu-title">
            ...
            <h3>Despues de los grandes momentos quedan inolvidables recuerdos </h3>
          </div>
          <!-- end title -->
          ...
          <div class="mu-gallery-content">
            ...
            <div class="mu-gallery-top">              
              <ul>
                ...
                <li class="filter" data-filter=".lab">Laboratorio</li>
                <li class="filter" data-filter=".classroom">Novatada</li>
                <li class="filter" data-filter=".library">Biblioteca</li>
                <li class="filter" data-filter=".cafe">Cafeteria</li>
               ...
               <li class="col-md-4 col-sm-6 col-xs-12 mix library">
                ...
                <li class="col-md-4 col-sm-6 col-xs-12 mix classroom">
                  <div class="mu-single-gallery">                  
                    <div class="mu-single-gallery-item">
                      <div class="mu-single-gallery-img">
                        <a href="#"><img alt="img" src="assets/images/plan.jpeg"></a>
                      </div>
                       <div class="mu-single-gallery-info">
                        <div class="mu-single-gallery-info-inner">
                          <h4>Image Title</h4>
                          <p>English</p>
                          <a href="assets/images/medidas.mp4" data-fancybox-group="gallery" class="fancybox"><span class="fa fa-eye"></span></a>
                          <a href="#" class="aa-link"><span class="fa fa-link"></span></a>
                        </div>
                      </div>
                    </div>
