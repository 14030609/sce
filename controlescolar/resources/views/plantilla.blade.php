...
<body>
                ...
                <ul class="nav navbar-nav pull-right mainNav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="assets/images/MapaCurricular.pdf">Mapa Curricular</a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Aspirantes<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="admision">Proceso Admision</a></li>
                            <li><a href="#">Propedeutico</a></li>
                          </ul>
                    </li>
    ...
    <header id="head">
        ...
        <div class="container">
             <div class="heading-text">                         
                            <h1 class="animated flipInY delay1">Preparatoria Plan Guanajuato </h1>
                            <p>Nunca consideres el estudio como una obligacion, sino como una oportunidad para penetrar en el bello y maravilloso mundo del saber ~Albert Einstein~</p>
                        </div>
  ...
  <div class="container">
    ...
    <iframe  width="425"   <source src="assets/images/UG.mp4"  frameborder="0" allowfullscreen 
            style="position:absolute; top:0; left:0; width:100%; height:100%;">
    </iframe>
</div>

<video width="380" controls>
  <source src="assets/images/medidas.mp4" type="video/mp4">
  <source src="assets/images/medidas.ogg" type="video/ogg">
