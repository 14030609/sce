                ...
                <div class="modal-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="name" class="form-control" id="horasprofesor">
                            </div>
                        </div>
                        <div class="form-group">
            ...
            success: function(data) {
                ...
                $('.item' + data.cvemat).replaceWith("<tr class='item" + data.cvemat + "'><td>" +
                        ...
                        "</td><td>" + data.creditos + "</td><td>" + data.horasprofesor + "</td><td>" +
                         data.horasautonomo + "</td><td>" + data.semestre +
                    "</td><td><button class='edit-modal btn btn-info' data-info='" + data.cvemat+","+data.nombre+","+data.creditos+","+data.horasprofesor+","+data.horasautonomo+","+data.semestre+"'>" +
                     "<span class='glyphicon glyphicon-edit'></span> Edit</button> <button class='delete-modal btn btn-danger' data-info='" + data.cvemat+","+data.nombre+","+data.creditos+","+data.horasprofesor+","+data.horasautonomo+","+data.semestre+"' >" +
